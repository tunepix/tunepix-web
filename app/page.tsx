...
const rooms = [
  { id: 0, name: "here we go!!!", members: 12 },
  { id: 1, name: "BAAAAR boo foo", members: 15 },
  { id: 2, name: "oooopsie", members: 2 },
  { id: 3, name: "BOOOOO", members: 47 },
];
      ...
      <div className="animate-in flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
        <div className="flex flex-col items-center mb-4 lg:mb-12">
          ...
          <div className="flex gap-4 items-center">
            <div className="bg-foreground py-3 px-6 rounded-lg text-background">
